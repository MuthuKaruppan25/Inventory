    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton(backgroundColor: Colors.redAccent,child: Padding(
          ...
          setState(() {
            orders.add([TextEditingController(text: ""),TextEditingController(text: ""),"6%",TextEditingController(text: ""),0,TextEditingController(text: ""),""]);
            count++;
          });
          ...
          IconButton(onPressed: ()async{
            ...
            if(n==0 && t==1 && y==1 && u==1) {
              ...
              if(o==0) {
                ...
                for(int i=0;i<orders.length;i++){
                  DocumentSnapshot data= await FirebaseFirestore.instance.collection("Items").doc("items").collection("items").doc(orders[i][0].text.toString()).get();
                  await FirebaseFirestore.instance.collection("Items").doc("items").collection("items").doc(orders[i][0].text.toString()).update({
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  SizedBox(height: 5,),
                                                  StreamBuilder<QuerySnapshot>(
                                                      stream:FirebaseFirestore.instance.collection("Items").doc("items").collection("items").where("name",whereNotIn: ele).snapshots(),
                                                  ...
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: [
                                                      Text("Hsn Number",style: TextStyle(fontSize: 15),),
                                                    ],
                                                  ),
                                                  SizedBox(height: 5,),
                                                  TextFormField(
