...
class _InvoicePageState extends State<InvoicePage> {
  ...
  void get()async{
    var x=await FirebaseFirestore.instance.collection("Customers").doc("customers").collection("customers").doc(widget.lis["custid"]).get();
                    ...
                    pw.Container(
                      ...
                      child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text(
                                "3/55, ANIYAPURAM PUDUR,\nMOHANUR ROAD,\nNAMAKKAL DIST",style: pw.TextStyle(
                                fontSize: 10
                            )
                            ),
                            pw.Text('GSTIN/UIN : 33BVJPM2871C1ZQ',style: pw.TextStyle(
                                fontSize: 10
                            )),
                            pw.Text('Phone : 7200810033',style: pw.TextStyle(
                                fontSize: 10
                            )),
                            pw.Text('E-Mail : akmultilinks@gmail.com',style: pw.TextStyle(
                                fontSize: 10
                            )),
                          ]
                      ),
                      ...
                      children: [
                        pw.Column(
                            ...
                            children: [
                              ...
                              pw.Text("Goods once sold will not be taken back\nAll disputes subject to NAMAKKAL Jurisdiction only.\nPrescribed Sales Tax declaration will be given."
                                  +"\n-----------------------------------------------------------------"+
                                  "\nCertified that the particulars given above are true and correct\nand the amount indicated represents the price actually charged.",style: pw.TextStyle(
                                fontSize: 9,
