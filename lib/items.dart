...
import 'package:inventory/edititems.dart';
import 'package:inventory/itemspage.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:StreamBuilder<QuerySnapshot>(
        stream:(_searchController.text=="")?FirebaseFirestore.instance.collection("Items").doc("items").collection("items").snapshots():FirebaseFirestore.instance.collection("Items").doc("items").collection("items").orderBy("name").snapshots()
            ...
            children: <Widget>[
              TextButton(
                onPressed: () async{
                  ...
                  await FirebaseFirestore.instance.collection("Universal").doc(name).delete();
                  await FirebaseFirestore.instance.collection(widget.dropdownValue).doc("itemstrash").collection("itemstrash").doc(name).set({
                    "name":name,
                    "price":price,
                    "quantity":quantity,
                    "iquantity":quantity,
