...
import 'package:inventory/presistant.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: DropdownButtonFormField(
                  ...
                  items: <String>['Apple', 'Samsung', 'Oppo', 'Vivo'].map<DropdownMenuItem<String>>((String value) {
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async{
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>  MyHomePage1(dropdownValue: dropdownValue.toString()),
                          ),
                        );
                      }
                        }
