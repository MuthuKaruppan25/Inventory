...
import 'package:inventory/customerspage.dart';
import 'package:inventory/editcustomer.dart';
            ...
            children: <Widget>[
              TextButton(
                onPressed: () async{
                  ...
                  await FirebaseFirestore.instance.collection("Customers").doc("customerstrash").collection("customerstrash").doc(name+phone).set({
                    "cusid":name+phone,
                    "name":name,
                    "street":street,
                    "city":city,
